  ...
  <div class="flex lt-sm:flex-col gap-4">
    <Card title="金额录入">
      <template #header-extra>
        <button
          type="button"
          class="cursor-pointer text-white transition-all text-14px mb-4 px-2 py-1 rounded-1 bg-blue-600 hover:bg-blue-500 hover:shadow"
          @click="handleAdd">
          新增
        </button>
      </template>
    ...
    <Card title="计算结果">
      ...
      <table border class="w-full bg-white mt-4">
